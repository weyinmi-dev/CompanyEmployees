...
using Service.Projects.Service.Contracts;
    ...
    public static class ServiceExtensions
    {
        ...
        public static void ConfigureSwagger(this IServiceCollection services)
        {
            services.AddSwaggerGen(s =>
            {
                ...
                Title = "CodeMaze Project by Weyinmi", 
                Version = "v1",
                Description = "CompanyEmployees API by Weyinmi",
                TermsOfService = new Uri("https://example.com/terms"),
                Contact = new OpenApiContact
                {
                    Name = "Weyinmi Madamedon",
                    Email = "dev-moe@gmail.com",
                    Url = new Uri("https://twitter.com/professor_moe"),
                },
                ...
                s.SwaggerDoc("v2", new OpenApiInfo { Title = "CodeMaze Project by Weyinmi", Version = "v2" });
